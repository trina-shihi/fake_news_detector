...
The repository includes `fake_news_dataset.csv`, containing news-related records with fields including:
...
```bash
git clone https://github.com/trina-shihi/fake_news_detector.git
